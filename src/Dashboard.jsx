...
import { Nav,Navbar,Container,Button,Form, NavDropdown, NavbarBrand, Row, Col } from 'react-bootstrap';
...
function Dashboard () {
    ...
    <>
        ...
        <Navbar bg="success" variant="dark" expand="lg" className="py-3">
            <Container>
                <Navbar.Brand href = "#home" style={{color:"white"}}>Personal Chat App</Navbar.Brand>
